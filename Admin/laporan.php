    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped">
                ...
                <?php
                include '../koneksi.php';
                $data = mysqli_query($koneksi,"select * from pelanggan, transaksi where pelanggan.pelanggan_id=transaksi.pelanggan_id and date(transaksi_tgl) > '$dari' and date(transaksi_tgl) < '$sampai' order by transaksi_id desc");
                $no = 1;
